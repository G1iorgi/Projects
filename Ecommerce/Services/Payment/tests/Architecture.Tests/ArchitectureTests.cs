...
{
    private readonly Assembly domainLayerAssembly = typeof(Payment.Domain.DependencyInjection).Assembly;
    private readonly Assembly applicationLayerAssembly = typeof(Payment.Application.DependencyInjection).Assembly;
    private readonly Assembly infrastructureLayerAssembly = typeof(Payment.Infrastructure.DependencyInjection).Assembly;
    private readonly Assembly presentationLayerAssembly = typeof(Payment.Presentation.DependencyInjection).Assembly;
    private readonly Assembly apiLayerAssembly = typeof(Payment.API.Assembly).Assembly;
