...
internal static class DbContextServiceCollectionExtensions
{
    ...
    {
        services.AddDbContext<CoreDbContextMaster>(options =>
        {
            options
                .UseLazyLoadingProxies()
                .UseNpgsql(configuration.GetConnectionString(nameof(CoreDbContextMaster)),
                    npgsqlBuilder =>
                        npgsqlBuilder.MigrationsHistoryTable(CoreDbContextMaster.MigrationHistoryTable,
