...
public class CategoryTests
{
    ...
    public void Create_Should_Succeed()
    {
        ...
        Assert.True(category.CreateDate <= DateTimeOffset.UtcNow);
    }
    ...
    [InlineData("")]
    [InlineData(" ")]
    public void UpdateMetadata_Should_ThrowExceptionOnInvalidData(string name)
    {
        // Arrange
        var category = Category.Create("Category 1");
    ...
    [Fact]
    public void NameHasChanged_Should_ThrowExceptionWhenNull()
    {
        // Arrange
        ...
        Assert.Throws<ArgumentNullException>(() =>
            category.NameHasChanged(name!));
    }

    [Theory]
    [InlineData("")]
    [InlineData("   ")]
    public void NameHasChanged_Should_ThrowExceptionWhenEmptyOrWhitespace(string name)
    {
        // Act
        var category = Category.Create("Category 1");
