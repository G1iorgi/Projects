...
{
    private readonly Assembly domainLayerAssembly = typeof(Shopping.Domain.DependencyInjection).Assembly;
    private readonly Assembly applicationLayerAssembly = typeof(Shopping.Application.DependencyInjection).Assembly;
    private readonly Assembly infrastructureLayerAssembly = typeof(Shopping.Infrastructure.DependencyInjection).Assembly;
    private readonly Assembly presentationLayerAssembly = typeof(Shopping.Presentation.DependencyInjection).Assembly;
    private readonly Assembly apiLayerAssembly = typeof(Shopping.API.Assembly).Assembly;
    ...
    public void PresentationLayer_ShouldReference()
    {
        ...
        Assert.Contains(applicationLayerName, presentationLayerDependenciesNames);
    }
